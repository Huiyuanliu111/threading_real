...
def main() -> int:
    ...
    parser.add_argument(
        "--repo-id",
        default="threading_real/threading_combined_pi05_15hz_sg5_nozero",
    )
    parser.add_argument(
        "--labels",
        type=Path,
        default=Path(
            "data/threading_combined_pi05_15hz_sg5_nozero_tcp_chunk_soft_labels_4_10_smoothed/labels.parquet"
        ),
    )
