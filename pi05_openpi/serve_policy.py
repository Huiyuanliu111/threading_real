...
def main():
 ...
 if settings.get('physical_action_dim')!=6 or settings.get('physical_state_dim')!=9 or settings['horizon']!=50:raise ValueError('Expected TCP6/state9/H50 configuration')
