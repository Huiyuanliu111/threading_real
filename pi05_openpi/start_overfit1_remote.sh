#!/usr/bin/env bash
# Isolated 1-episode memorization diagnostic, initialized from pi05_base.
set -euo pipefail
...
ARGS=(
  ...
  --camera-views cam1 --exp-name threading_tcp6_cam1_native640_overfit1_v10
  --dataset-root "$DATASET" --repo-id threading_real/threading_tcp6_native640_30hz
  --overfit-episodes 1 --seed 42 --batch-size 6 --fsdp-devices 2
