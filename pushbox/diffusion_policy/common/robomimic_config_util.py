...
# Monkey-patch: robomimic 0.3.0 removed CropRandomizer; use pushbox's own
import robomimic.models.base_nets as rmbn
import robomimic.utils.obs_utils as ObsUtils
# Remove original CropRandomizer registration so pushbox version can register itself
ObsUtils.OBS_RANDOMIZERS.pop("CropRandomizer", None)
from pushbox.diffusion_policy.model.vision.crop_randomizer import CropRandomizer
rmbn.CropRandomizer = CropRandomizer
