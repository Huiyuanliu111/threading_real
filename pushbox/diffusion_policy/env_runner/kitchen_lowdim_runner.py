...
class KitchenLowdimRunner(BaseLowdimRunner):
    def __init__(self,
        ...
        def env_fn():
            from pushbox.diffusion_policy.env.kitchen.v0 import KitchenAllV0
            from pushbox.diffusion_policy.env.kitchen.kitchen_lowdim_wrapper import KitchenLowdimWrapper
