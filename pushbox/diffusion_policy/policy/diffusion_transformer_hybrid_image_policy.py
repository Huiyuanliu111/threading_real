...
from pushbox.diffusion_policy.model.diffusion.transformer_for_diffusion import TransformerForDiffusion
...
class DiffusionTransformerHybridImagePolicy(BaseImagePolicy):
    ...
    def compute_loss(self, batch):
        ...
        pred = self.model(noisy_trajectory, timesteps, cond) # cond: [64, 2, 66]
