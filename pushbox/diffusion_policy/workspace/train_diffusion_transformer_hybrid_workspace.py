...
from pushbox.diffusion_policy.policy.diffusion_transformer_hybrid_image_policy import DiffusionTransformerHybridImagePolicy
...
class TrainDiffusionTransformerHybridWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        if add_full_horizon_eval:
            ...
            _env_runner_cfg.n_action_steps = cfg.horizon - 1
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if (self.epoch % cfg.training.rollout_every) == 0:
                    ...
                    if add_full_horizon_eval:
                        ...
                        policy.n_action_steps = cfg.horizon - 1
