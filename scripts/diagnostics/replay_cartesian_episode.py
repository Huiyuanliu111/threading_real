...
from scripts.deployment.joint import GripperController, PANDA_LOWER, PANDA_UPPER, diagonal_stiffness  # noqa: E402
from scripts.deployment.cartesian import cartesian_stiffness  # noqa: E402
